    ...
    <>
        ...
        <div className="hero">
          <div className="content">
            ...
            <p className="section-paragraph">
              Our commitment to using only the highest quality ingredients
              ensures that every dish is bursting with flavor. Whether you're
              looking for a quick bite or a gourmet meal, we've got you covered.
            </p>
      ...
      <section id="cards-info">
        <div className="cards-info">
          <div
            className="banner"
            style={{ backgroundImage: `url(${storeFrontSrc})` }}
          />
            ...
            <div className="card">
              ...
              <div className="details">
                <div className="details__item">
                  ...
                  <a
                    target="_blank"
                    href="https://www.instagram.com/Foody.cucinare/"
                    className="value"
                  >
                    Foody.cucinare
                  </a>
                ...
                <div className="details__item">
                  ...
                  <a
                    target="_blank"
                    href="https://www.tiktok.com/@Foody.cucinare"
                    className="value"
                  >
                    Foody.cucinare
                  </a>
                ...
                <div className="details__item">
                  ...
                  <a
                    target="_blank"
                    href="https://www.facebook.com/Foody.cucinare"
                    className="value"
                  >
                    Foody.cucinare
                  </a>
        ...
        <div className="about section-py">
          <div className="content">
            <div className="section-heading">
              ...
              <p className="section-paragraph">
                Indulge in the complexity and depth of flavors as they dance on
                your tongue, leaving you with a lasting impression.
              </p>
            </div>
          ...
          <div
            className="banner"
            style={{ backgroundImage: `url(${lasagnaSrc})` }}
          />
        </div>
      </section>
