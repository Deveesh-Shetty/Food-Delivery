      ...
      <div className="feedback">
        <div className="section-heading">
          ...
          <p className="section-paragraph">
            Many have praised the delicious and unique flavors in our dishes,
            stating that the seasonings and spices used were well-balanced and
            added a great depth of taste.
          </p>
        </div>
