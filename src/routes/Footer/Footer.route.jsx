    ...
    <footer className="footer section-px">
        ...
        <div className="left">
          ...
          <div className="contact">
            ...
            <div className="group">
              ...
              <a
                href="mailto:Foody.cucinareofficialph@gmail.com"
                className="group__link"
              >
                Foody.Food@gmail.com
              </a>
            </div>
          </div>
      ...
      <div className="bottom">
        ...
        <div className="credits">
          Copyright <span className="credits__icon">&copy;</span> 2023 Foody.
          All rights Reserved
        </div>
      </div>
      ...
      {/* <div className="info">
                <div className="contact">
                    ...
                    <div className="contact__detail">
                        ...
                        <a href="mailto:Foody.cucinareofficialph@gmail.com" className="value">
                            Foody.cucinareofficialph@gmail.com
                        </a>
                    </div>
                </div>
